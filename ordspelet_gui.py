...
class OrdspelGUI:
    ...
    def go_gui(self):
        ...
        # TABLE OF CONTENTS - CURRENT TAB
        """
        Current tab is for "Part 1" in the assignment. Where the Program plays against the User.
        ...
        # 4.0 - GUI WIDGETS
        app.addEmptyLabel("tab1_0_EL0", column=y_group0, row=x_group0)
        ...
        # 4.1 - GUI WIDGETS
        app.addLabel(title="tab1_1_L0", column=y_group1, row=x_group0, text=info_text)
        ...
        # 4.1 - GUI WIDGETS
        app.addLabel(title="1_L0", column=y_group1, row=x_group0, rowspan=1, text=info_text)
